...
## Open on the decision, not the announcement

Skip "I'm excited to announce" and "Today, we're launching." Those are
the most generic openers in the genre.

Open on the moment the project became real: looking at what existed,
concluding it did not fit, deciding to build. One or two sentences of
why, then into what that meant.

A consulting practice that tells clients how to use a tool, then ships a
working product, should write a **build report**, not a launch post. What
building taught you is the interesting part. The product site can carry
the origin story and the catalog.
...
- **Stacked CTAs.** One primary outbound link in the body. Site chrome
  can carry a second. Do not end every section with a button.
...
claim a competitor cannot copy by rewriting their copy.
...
and do not pretend a company wrote the scars.
